...
export class MinimapIcons extends Plugin {
    ...
    private iconConfigs: IconConfig[] = [
        ...
        { field: CompareField.Description, compareType: CompareType.Equals, value: "gem shop", icon: gemShopIcon },
        ...
        { field: CompareField.Name, compareType: CompareType.Equals, value: "palm tree", icon: palmTreeIcon },
        { field: CompareField.Name, compareType: CompareType.Equals, value: "pine tree", icon: pineTreeIcon },
        { field: CompareField.Name, compareType: CompareType.Equals, value: "cherry blossom", icon: cherryBlossomTreeIcon },
        { field: CompareField.Name, compareType: CompareType.Equals, value: "money tree", icon: moneyTreeIcon },
        { field: CompareField.Name, compareType: CompareType.Equals, value: "deadwood tree", icon: deadwoodTreeIcon },
        { field: CompareField.Name, compareType: CompareType.Equals, value: "plant", icon: plantIcon },
        { field: CompareField.Name, compareType: CompareType.Equals, value: "stove", icon: cookingIcon },
        { field: CompareField.Name, compareType: CompareType.Equals, value: "tree", icon: treeIcon },
        { field: CompareField.Name, compareType: CompareType.Equals, value: "oak tree", icon: oakTreeIcon },
        ...
        { field: CompareField.Name, compareType: CompareType.Includes, value: "coal rocks", icon: coalIcon },
        { field: CompareField.Name, compareType: CompareType.Includes, value: "tin rocks", icon: tinIcon },
        { field: CompareField.Name, compareType: CompareType.Includes, value: "copper rocks", icon: copperIcon },
        { field: CompareField.Name, compareType: CompareType.Includes, value: "iron rocks", icon: ironIcon },
        { field: CompareField.Name, compareType: CompareType.Includes, value: "silver rocks", icon: silverIcon },
        ...
        try {
            ...
            for (const [entityId, npc] of npcs) {
                ...
                if (!this.minimapIcons.has(entityId)) {
                    ...
                    this.createIcon(entityId, 'npc', defId, npc._name || `NPC ${defId}`, npc, entityPos);
                }
            }
        } catch (error) {
        ...
        try {
            ...
            for (const [entityId, obj] of objects) {
                ...
                if (!this.minimapIcons.has(entityId)) {
                    ...
                    this.createIcon(entityId, 'object', defId, obj._name || `Object ${defId}`, obj, entityPos);
                }
            }
        } catch (error) {
